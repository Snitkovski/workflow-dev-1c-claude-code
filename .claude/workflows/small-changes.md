...
1. **Только необходимое:**
   ...
   - Избегать спекулятивных добавлений

2. **Сохранить стиль:**
   - Следовать существующему форматированию
   - Использовать те же паттерны
   - Проверить через MCP `codesearch` как сделано в проекте
...
2. **Логика и производительность:**
   ```
   MCP check_1c_code → анализ проблем
   ```
...
- [ ] syntaxcheck пройден
- [ ] check_1c_code без критических замечаний
- [ ] Изменение минимально
- [ ] Стиль сохранён
- [ ] Зависимости проверены
- [ ] Нет анти-паттернов (см. anti-patterns.md)
