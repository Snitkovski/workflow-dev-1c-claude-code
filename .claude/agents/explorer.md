...
| codesearch (MCP) | Поиск паттернов в коде конфигурации |
| search_metadata (MCP) | Структура метаданных |
| business_search (MCP) | Семантический поиск по бизнес-логике |
| answer_metadata_question (MCP) | Ответы о поведении объектов |
